# -*- coding: utf-8 -*-
# A optimisé au max
# Il semble y avoir un pb lors du changement de joueur pmeepo
import sys
import copy
sys.path.append("../..")
import game
...
"""
    ...
    parametre optimaux par trainer : [2.4, 7.69, 3.9]
"""
param=[0.4,0.5,0.3]
coeffparam1 = param[0]
coeffparam2 = param[1]
...
def nextCase(jeu, case):
    """
    	jeu*case -> case
        voie la case situee apres celle entree en parametre
        """

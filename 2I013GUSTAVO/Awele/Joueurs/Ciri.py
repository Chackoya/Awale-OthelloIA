# -*- coding: utf-8 -*-
# A optimisé au max
# Il semble y avoir un pb lors du changement de joueur DROW
import sys
import copy
sys.path.append("../..")
import game
...
j_initial = []
global params
params=[5.632777777777772,-0.12708333333333402,-7.98458333333336]
coeffparam1=params[0]
coeffparam2=params[1]
coeffparam3=params[2]
...
def evaluation(jeu2):
    ...
    """
    return coeffparam1*a1(jeu2)+coeffparam2*a2(jeu2)+coeffparam3*a3(jeu2)

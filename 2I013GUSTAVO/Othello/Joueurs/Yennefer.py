...
weightsC = [	[200, -20,  20,   5,   5,  20, -20, 200],
				[-20, -40,  -5,  -5,  -5,  -5, -40, -20],
				[20,  -5,  15,   3,   3,  15,  -5,  20],
				[5,  -5,   3,   3,   3,   3,  -5,   5],
				[5,  -5,   3,   3,   3,   3,  -5,   5],
...
def parcoursPlateau(jeu):
    """ jeu -> int
        ...
        * du tableau weightsC qui correspond au poids de chaque Case du plateau
...
def f3(jeu,liste):
    ...
    if (game.getJoueur == moi and (coupsValMoi+coupsValAdv != 0)):
        return (coupsValMoi-coupsValAdv)/(coupsValMoi+coupsValAdv)
    return 0
